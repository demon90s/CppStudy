...
> [==显式实例化案例代码==](https://github.com/demon90s/CppStudy/tree/master/ch16_Templates_and_GenericProgramming/example_explicit_instantiation)，在这个例子中，我将实例化声明放在头文件里，而将显式的实例化定义放在源文件里。
...
[==自定义的智能指针==](https://github.com/demon90s/CppStudy/tree/master/ch16_Templates_and_GenericProgramming/example_SmartPointer)可以更直观地解释上述说明。
