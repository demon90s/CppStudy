...
[参考代码](../../codes/CppPrimer/labs/string/construct.cpp)
...
[参考代码](../../codes/CppPrimer/labs/string/api_substr.cpp)
...
- [insert](../../codes/CppPrimer/labs/string/api_insert.cpp)
- [erase](../../codes/CppPrimer/labs/string/api_erase.cpp)

assign 版本还接受C风格字符串：

- [assign](../../codes/CppPrimer/labs/string/api_assign.cpp)

append 和 replace 是额外的成员函数， append 在 string 末尾进行插入操作， replace 替换内容，它是调用 erase 和 insert 的一种简写形式：

- [append](../../codes/CppPrimer/labs/string/api_append.cpp)
- [replace](../../codes/CppPrimer/labs/string/api_replace.cpp)

### string 搜索操作

string 提供了6个搜索函数，它们都有4个重载版本。它们都返回一个 string::size_type 的值作为匹配位置（下标）。如果搜索失败，返回 string::npos ，其值为 -1 。

- [find](../../codes/CppPrimer/labs/string/api_find.cpp)
- [rfind](../../codes/CppPrimer/labs/string/api_rfind.cpp)
- [find_first_of](../../codes/CppPrimer/labs/string/api_find_first_of.cpp)
- [find_last_of](../../codes/CppPrimer/labs/string/api_find_last_of.cpp)
- [find_first_not_of](../../codes/CppPrimer/labs/string/api_find_first_not_of.cpp)
- [find_last_not_of](../../codes/CppPrimer/labs/string/api_find_last_not_of.cpp)
...
- [compare](../../codes/CppPrimer/labs/string/api_compare.cpp)
...
- [to_string](../../codes/CppPrimer/labs/string/api_to_string.cpp)
- [stoi, stol, stoul, stof等](../../codes/CppPrimer/labs/string/stoi_stol_stoul_stof.cpp)